...
//arrow function for customized user greeting

const greetUser = (username => {
    console.log(`Welcome back ${username}!`)
})

//console.log(greetUser('abcd'))
...
//code to notify customers of delivery eligibility
...
//console.log(canWeDeliver(11217))
...
// another way to check for delivery eligbility
...
//console.log(canWeDeliverTwo(11567))
...
//sale update! change discount from 15% off to 10% off using string method replace
...
//extending sale until April using string method replace
